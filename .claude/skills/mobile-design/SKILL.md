...
| File                          | Purpose                            | Status            |
| ----------------------------- | ---------------------------------- | ----------------- |
| **resources/mobile-design-thinking.md** | Anti-memorization, context-forcing | 🔴 REQUIRED FIRST |
| **resources/touch-psychology.md**       | Fitts' Law, thumb zones, gestures  | 🔴 REQUIRED       |
| **resources/mobile-performance.md**     | 60fps, memory, battery             | 🔴 REQUIRED       |
| **resources/mobile-backend.md**         | Offline sync, push, APIs           | 🔴 REQUIRED       |
| **resources/mobile-testing.md**         | Device & E2E testing               | 🔴 REQUIRED       |
| **resources/mobile-debugging.md**       | Native vs JS debugging             | 🔴 REQUIRED       |

### Platform-Specific (Conditional)

| Platform       | File                |
| -------------- | ------------------- |
| iOS            | resources/platform-ios.md     |
| Android        | resources/platform-android.md |
