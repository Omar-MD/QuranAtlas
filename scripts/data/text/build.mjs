...
export async function main() {
  ...
  // scripts/data/derive-verse-aliases.mjs). The canonical alias table lives
  // in tracked data/catalog and is copied into the dataset here; refresh it
  // explicitly with `pnpm run data -- aliases` after a riwayah source bump.
  await mkdir(TRANSLATIONS_DIR, { recursive: true })
