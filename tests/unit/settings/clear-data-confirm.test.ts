...
vi.mock('../../../src/settings/clear-data.ts', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../../../src/settings/clear-data.ts')>()
  return { ...actual, clearAllData: vi.fn(async () => true) }
})

import ClearDataConfirm from '../../../src/settings/ClearDataConfirm.svelte'
import { showClearDataConfirmation, clearAllData } from '../../../src/settings/clear-data.ts'
