...
import { applyTheme, getThemeOptions, initTheme, setTheme } from '../../../src/settings/theme.js'
...
describe('settings/theme.js', () => {
  ...
  it('logs persistence failures without rolling back the applied theme', async () => {
    ...
    const { setTheme: setThemeWithFailure } = await import('../../../src/settings/theme.js')
