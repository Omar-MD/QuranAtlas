...
| search | Search route, lexical/morphology Search, and memory-graph Explore components | `src/app/routes/search/**`, `src/components/search/**`, `src/search/**`, `src/search-worker/**`, `src/offline/search/**` | `src/design-system/index.css` | `src/components/search/search.stories.tsx`, `tests/unit/react-search/**`, and `tests/e2e/search/*.spec.ts` |
