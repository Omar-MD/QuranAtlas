...
- Dataset profiles:
  - `baseline`: emits Qaloon riwayah, Bridges translation, Muyassar tafsir, core metadata, source indexes, manifest, provenance, and same-origin optional translation/tafsir pack files that stay outside the manifest.
