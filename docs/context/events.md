...
| `Events.BOOKMARKS_SAVE_FAILED` | `bookmarks:save-failed` | `src/bookmarks/store.ts:42` | `src/core/save-failure-toast.svelte:29` |
...
| `Events.MARKS_SAVE_FAILED` | `marks:save-failed` | `src/marks/store.ts:95` | `src/core/save-failure-toast.svelte:26` |
