...
| `Events.APP_INIT_ERROR` | `app:init-error` | `src/app-bootstrap.ts:343`<br>`src/app-bootstrap.ts:437` | `src/core/save-failure-toast.svelte:41` |
| `Events.APP_READY_FOR_DOWNLOAD` | `app:ready-for-download` | `src/app-bootstrap.ts:498` | _(none)_ |
| `Events.APP_UPDATE_AVAILABLE` | `app:update-available` | `src/app-bootstrap.ts:416`<br>`src/app-bootstrap.ts:427` | `src/core/UpdateBanner.svelte:19` |
...
| `Events.OFFLINE_DOWNLOAD_ERROR` | `offline:download-error` | `src/data/offline.ts:277`<br>`src/data/offline.ts:292`<br>`src/data/offline.ts:336`<br>`src/data/offline.ts:388`<br>`src/data/offline.ts:407`<br>`src/data/offline.ts:481`<br>`src/data/offline.ts:516` | _(none)_ |
...
| `Events.OFFLINE_SW_TIMEOUT` | `offline:sw-timeout` | `src/data/offline.ts:238` | _(none)_ |
...
| `Events.ROUTER_LAUNCH_RESTORE` | `router:launch-restore` | `src/core/router.ts:148` | `src/app-bootstrap.ts:212` |
...
| `Events.STORAGE_QUOTA_WARNING` | `storage:quota-warning` | `src/data/offline.ts:149` | `src/core/quota-banner.svelte:18` |
...
- `Events.APP_READY_FOR_DOWNLOAD` (`app:ready-for-download`) — emitted at `src/app-bootstrap.ts:498`
...
- `Events.OFFLINE_DOWNLOAD_ERROR` (`offline:download-error`) — emitted at `src/data/offline.ts:277`<br>`src/data/offline.ts:292`<br>`src/data/offline.ts:336`<br>`src/data/offline.ts:388`<br>`src/data/offline.ts:407`<br>`src/data/offline.ts:481`<br>`src/data/offline.ts:516`
...
- `Events.OFFLINE_SW_TIMEOUT` (`offline:sw-timeout`) — emitted at `src/data/offline.ts:238`
