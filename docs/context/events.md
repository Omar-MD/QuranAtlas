...
Total events declared: **55**. Live emits: **53**. Live listeners: **29**.

Dead (declared but neither emitted nor listened): **2**.
Orphan emit (emitted, never listened): **24**.
...
| `Events.APP_INIT_ERROR` | `app:init-error` | `src/app-bootstrap.ts:334`<br>`src/app-bootstrap.ts:428` | `src/core/save-failure-toast.svelte:41` |
...
| `Events.DATASET_APPLIED` | `dataset:applied` | `src/data/offline.ts:346` | _(none)_ |
| `Events.DATASET_DOWNLOAD_PROGRESS` | `dataset:download-progress` | `src/data/offline.ts:361` | _(none)_ |
| `Events.DATASET_PENDING_CONFIRMATION` | `dataset:pending-confirmation` | `src/data/offline.ts:339` | _(none)_ |
| `Events.DATASET_UPDATE_AVAILABLE` | `dataset:update-available` | `src/data/offline.ts:354` | _(none)_ |
| `Events.DATASET_UPDATE_FAILED` | `dataset:update-failed` | `src/data/offline.ts:351` | _(none)_ |
...
| `Events.NAVIGATION_NAVIGATE` | `navigation:navigate` | `src/navigate/CommandSheet.svelte:303`<br>`src/navigate/CommandSheet.svelte:305`<br>`src/navigate/NavDrawer.svelte:252`<br>`src/navigate/NavDrawer.svelte:327`<br>`src/navigate/NavDrawer.svelte:713`<br>`src/navigate/bookmarks/BookmarksList.svelte:106`<br>`src/navigate/surahs/SurahList.svelte:167` | `src/app-bootstrap.ts:296` |
| `Events.OFFLINE_DOWNLOAD_COMPLETE` | `offline:download-complete` | `src/data/offline.ts:284`<br>`src/data/offline.ts:323`<br>`src/data/offline.ts:426`<br>`src/data/offline.ts:506` | _(none)_ |
| `Events.OFFLINE_DOWNLOAD_ERROR` | `offline:download-error` | `src/data/offline.ts:276`<br>`src/data/offline.ts:291`<br>`src/data/offline.ts:335`<br>`src/data/offline.ts:387`<br>`src/data/offline.ts:406`<br>`src/data/offline.ts:480`<br>`src/data/offline.ts:515` | _(none)_ |
| `Events.OFFLINE_DOWNLOAD_PROGRESS` | `offline:download-progress` | `src/data/offline.ts:311`<br>`src/data/offline.ts:424`<br>`src/data/offline.ts:500` | `src/data/offline.ts:601` |
| `Events.OFFLINE_INSTALL_AVAILABLE` | `offline:install-available` | `src/data/offline.ts:615` | _(none)_ |
| `Events.OFFLINE_INSTALL_COMPLETE` | `offline:install-complete` | `src/data/offline.ts:620` | _(none)_ |
| `Events.OFFLINE_RIWAYAH_PACKAGE_ERROR` | `offline:riwayah-package-error` | `src/data/offline.ts:473`<br>`src/data/offline.ts:479`<br>`src/data/offline.ts:485`<br>`src/data/offline.ts:514` | _(none)_ |
| `Events.OFFLINE_RIWAYAH_PACKAGE_PROGRESS` | `offline:riwayah-package-progress` | `src/data/offline.ts:499` | _(none)_ |
| `Events.OFFLINE_SW_TIMEOUT` | `offline:sw-timeout` | `src/data/offline.ts:237` | _(none)_ |
...
| `Events.SETTINGS_RIWAYAH_CHANGED` | `settings:riwayah-changed` | `src/configure/riwayah.ts:74`<br>`src/configure/riwayah.ts:127` | `src/app-bootstrap.ts:174`<br>`src/configure/reading-typography.ts:133`<br>`src/navigate/bookmarks/BookmarksList.svelte:227`<br>`src/navigate/bookmarks/BookmarksPage.svelte:36`<br>`src/navigate/bookmarks/indicator.ts:102`<br>`src/navigate/surahs/SurahList.svelte:140`<br>`src/read/Reader.svelte:509`<br>`src/read/mushaf/MushafReader.svelte:354` |
| `Events.SHEET_CLOSED` | `sheet:closed` | `src/configure/Panel.svelte:182`<br>`src/navigate/shortcuts-sheet.js:162` | _(none)_ |
| `Events.SHEET_OPENED` | `sheet:opened` | `src/configure/Panel.svelte:165`<br>`src/navigate/shortcuts-sheet.js:153` | _(none)_ |
| `Events.STORAGE_QUOTA_WARNING` | `storage:quota-warning` | `src/data/offline.ts:148` | `src/core/quota-banner.svelte:18` |
...
- `Events.DATASET_APPLIED` (`dataset:applied`) — emitted at `src/data/offline.ts:346`
- `Events.DATASET_DOWNLOAD_PROGRESS` (`dataset:download-progress`) — emitted at `src/data/offline.ts:361`
- `Events.DATASET_PENDING_CONFIRMATION` (`dataset:pending-confirmation`) — emitted at `src/data/offline.ts:339`
- `Events.DATASET_UPDATE_AVAILABLE` (`dataset:update-available`) — emitted at `src/data/offline.ts:354`
- `Events.DATASET_UPDATE_FAILED` (`dataset:update-failed`) — emitted at `src/data/offline.ts:351`
...
- `Events.OFFLINE_DOWNLOAD_COMPLETE` (`offline:download-complete`) — emitted at `src/data/offline.ts:284`<br>`src/data/offline.ts:323`<br>`src/data/offline.ts:426`<br>`src/data/offline.ts:506`
- `Events.OFFLINE_DOWNLOAD_ERROR` (`offline:download-error`) — emitted at `src/data/offline.ts:276`<br>`src/data/offline.ts:291`<br>`src/data/offline.ts:335`<br>`src/data/offline.ts:387`<br>`src/data/offline.ts:406`<br>`src/data/offline.ts:480`<br>`src/data/offline.ts:515`
- `Events.OFFLINE_INSTALL_AVAILABLE` (`offline:install-available`) — emitted at `src/data/offline.ts:615`
- `Events.OFFLINE_INSTALL_COMPLETE` (`offline:install-complete`) — emitted at `src/data/offline.ts:620`
- `Events.OFFLINE_RIWAYAH_PACKAGE_ERROR` (`offline:riwayah-package-error`) — emitted at `src/data/offline.ts:473`<br>`src/data/offline.ts:479`<br>`src/data/offline.ts:485`<br>`src/data/offline.ts:514`
- `Events.OFFLINE_RIWAYAH_PACKAGE_PROGRESS` (`offline:riwayah-package-progress`) — emitted at `src/data/offline.ts:499`
- `Events.OFFLINE_SW_TIMEOUT` (`offline:sw-timeout`) — emitted at `src/data/offline.ts:237`
...
- `Events.SHEET_CLOSED` (`sheet:closed`) — emitted at `src/configure/Panel.svelte:182`<br>`src/navigate/shortcuts-sheet.js:162`
- `Events.SHEET_OPENED` (`sheet:opened`) — emitted at `src/configure/Panel.svelte:165`<br>`src/navigate/shortcuts-sheet.js:153`
