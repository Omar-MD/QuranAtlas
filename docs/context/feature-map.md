...
| **navigate** | [`surfaces/navigate.md`](surfaces/navigate.md) | Reader navigation — nav drawer, Surah/Juz browsing, bookmarks, reader mode switching, shortcuts, and Daily Wird entry points. Bookmark persistence and resume validation are consumed from `src/continuity/**`. |
