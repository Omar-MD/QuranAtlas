...
| **mark** | [`surfaces/mark.md`](surfaces/mark.md) | Existing-mark editing and persistence. Review opens the deep TagSheet for saved marks, but the Reader no longer creates new marks from its primary per-verse actions. |
