...
Forbidden traits: no partial-height mobile modal, no all-purpose Settings inventory, no search or fast-navigation promise, no one-off Verse-only theme control, no purple gradients, no floating blob decoration, no fake decorative calligraphy, no nested generic card stack, and no marketing header.
